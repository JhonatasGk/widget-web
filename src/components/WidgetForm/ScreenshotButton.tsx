...
export function ScreenshotButton({ screenshot, onScreenshotTook}: ScreenshotButtonProps){
        ...
        return (
            <button 
                ...
                style={{
                    ...
                    // styles below, just for component testing, delete later
    ...
    return(
        <button
            ...
            type="button"   
            className="p-2 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-400 focus:ring-2 
            transition-colors focus:outline-none focus:ring-offset-2  focus:ring-offset-zinc-900 
