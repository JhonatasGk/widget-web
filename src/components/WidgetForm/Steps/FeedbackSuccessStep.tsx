...
export function FeedbackSuccessStep({onFeedbackRestartRequested}: FeedbackSuccessStepProps){
    ...
    return(
        ...
        <div className="flex flex-col  items-center py-10 w-[304px]">
            ...
            <span className="text-xl mt-2 dark:text-dark-text-primary text-light-text-primary ">Agradecemos seu feedback!</span>
            <button
                type="button"
                onClick={onFeedbackRestartRequested}
                className="py-2 px-6 mt-6 bg-light-surface-secondary dark:bg-dark-surface-secondary rounded-md border-transparent text-sm
